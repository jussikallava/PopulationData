// package fi.kallava.population.test;
...
// import fi.kallava.population.Application;
// import fi.kallava.population.api.rest.PopulationController;
// import fi.kallava.population.domain.Citizen;
...
//     private static final String RESOURCE_LOCATION_PATTERN = "http://localhost/example/v1/citizens/[0-9]+";
...
//         mvc.perform(get("/example/v1/citizens")
...
//         Citizen r1 = mockCitizen("shouldCreateRetrieveDelete");
//         byte[] r1Json = toJson(r1);

//         //CREATE
//         MvcResult result = mvc.perform(post("/example/v1/citizens")
//                 .content(r1Json)
...
//         //RETRIEVE
//         mvc.perform(get("/example/v1/citizens/" + id)
//                 .accept(MediaType.APPLICATION_JSON))
//                 .andExpect(status().isOk())
...
//         //DELETE
//         mvc.perform(delete("/example/v1/citizens/" + id))
...
//         Citizen r1 = mockCitizen("shouldCreateAndUpdate");
//         byte[] r1Json = toJson(r1);
//         //CREATE
//         MvcResult result = mvc.perform(post("/example/v1/citizens")
//                 .content(r1Json)
...
//         Citizen r2 = mockCitizen("shouldCreateAndUpdate2");
//         r2.setId(id);
//         byte[] r2Json = toJson(r2);

//         //UPDATE
//         result = mvc.perform(put("/example/v1/citizens/" + id)
//                 .content(r2Json)
//                 .contentType(MediaType.APPLICATION_JSON)
//                 .accept(MediaType.APPLICATION_JSON))
//                 .andExpect(status().isNoContent())
...
//     private Citizen mockCitizen(String prefix) {
//         Citizen r = new Citizen();
